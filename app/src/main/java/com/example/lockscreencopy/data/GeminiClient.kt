...
object GeminiClient {
        ...
        withContext(Dispatchers.IO) {
            ...
            val prompt = """
                ...
                - 예) "운동 간다" → 헬스 앱만이 아니라 음악/플레이리스트, 타이머·스톱워치,
                  지도·러닝 경로, 날씨, 물·수분 섭취, 심박/걸음 기록, 운동 후 식단까지.
                - 예) "재미있는 거 찾아줘" → 게임만이 아니라 영상·OTT, 음악, 웹툰, 커뮤니티,
    ...
    suspend fun recommendWidgets(
        ...
        val prompt = """
            ...
            먼저 사용자가 그 상황에서 "실제로 보내는 시간"을 한 편의 장면처럼 그려보세요.
            요구를 글자 그대로만 해석하지 말고, 그 행동에 자연스럽게 따라오는
            준비·이동·기록·휴식·공유까지 하나의 흐름으로 상상해 폭넓게 떠올리세요.
            - 예) "운동 간다" → 운동 앱만이 아니라 음악/플레이리스트, 타이머·스톱워치,
              지도·러닝 경로, 날씨, 물·수분 섭취, 걸음·심박, 운동 후 식단까지.
            - 예) "재미있는 거 찾아줘" → 게임만이 아니라 영상·OTT, 음악, 웹툰, 커뮤니티,
              쇼츠, 라이브 등 사람마다 다른 '재미'의 결을 폭넓게.
            ...
            고를 때 원칙:
            - 한 카테고리에 몰지 말고 서로 다른 결을 가진 후보를 섞어 폭을 넓히세요.
            - 뻔한 1순위 외에 "아 이것도 있으면 좋지" 싶은 곁가지도 함께 담으세요.
